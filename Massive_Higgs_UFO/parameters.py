...
gA0tt = Parameter(name = 'gA0tt',
                  nature = 'external',
                  type = 'real',
                  value = 1,
                  texname = 'g_{\\text{tt} A^0}',
                  lhablock = 'A0PARAMS',
                  lhacode = [ 1 ])
...
gH0tt = Parameter(name = 'gH0tt',
                  nature = 'external',
                  type = 'real',
                  value = 1,
                  texname = 'g_{\\text{tt} H^0}',
                  lhablock = 'H0PARAMS',
                  lhacode = [ 1 ])
...
H0Width = Parameter(name = 'H0Width',
                    nature = 'external',
                    type = 'real',
                    value = 50,
                    texname = '\\text{H0Width}',
...
A0Width = Parameter(name = 'A0Width',
                    nature = 'external',
                    type = 'real',
                    value = 50,
                    texname = '\\text{A0Width}',
...
A0PartialWidth = Parameter(name = 'A0PartialWidth',
                           nature = 'internal',
                           type = 'real',
                           value = '(3*gA0tt**2*MA0*MT**2*cmath.sqrt(1 - (4*MT**2)/MA0**2))/(8.*cmath.pi*vev**2)',
                           texname = '\\text{A0PartialWidth}')

H0PartialWidth = Parameter(name = 'H0PartialWidth',
                           nature = 'internal',
                           type = 'real',
                           value = '(3*gH0tt**2*MH0*MT**2*(1 - (4*MT**2)/MH0**2)**1.5)/(8.*cmath.pi*vev**2)',
                           texname = '\\text{H0PartialWidth}')

gA0gg = Parameter(name = 'gA0gg',
                  nature = 'internal',
                  type = 'real',
                  value = '(G**2*gA0tt)/(8.*cmath.pi**2*vev)',
                  texname = 'g_{\\text{gg} A^0}')

gH0gg = Parameter(name = 'gH0gg',
                  nature = 'internal',
                  type = 'real',
                  value = '(G**2*gH0tt)/(16.*cmath.pi**2*vev)',
                  texname = 'g_{\\text{gg} H^0}')
