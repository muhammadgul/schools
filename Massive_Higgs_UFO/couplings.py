...
GC_86 = Coupling(name = 'GC_86',
                 value = '(complex(0,1)*gH0tt*MT)/vev',
                 order = {'HIG':1,'QED':1})

GC_87 = Coupling(name = 'GC_87',
                 value = '(complex(0,1)*G**2*gA0tt)/(64.*cmath.pi**2*vev)',
                 order = {'HIG':1,'QCD':2,'QED':1})

GC_88 = Coupling(name = 'GC_88',
                 value = '(G**3*gA0tt)/(32.*cmath.pi**2*vev)',
                 order = {'HIG':1,'QCD':3,'QED':1})

GC_89 = Coupling(name = 'GC_89',
                 value = '-(complex(0,1)*G**2*gH0tt)/(16.*cmath.pi**2*vev)',
                 order = {'HIG':1,'QCD':2,'QED':1})

GC_90 = Coupling(name = 'GC_90',
                 value = '-(G**3*gH0tt)/(16.*cmath.pi**2*vev)',
                 order = {'HIG':1,'QCD':3,'QED':1})

GC_91 = Coupling(name = 'GC_91',
                 value = '(complex(0,1)*G**4*gH0tt)/(16.*cmath.pi**2*vev)',
                 order = {'HIG':1,'QCD':4,'QED':1})
